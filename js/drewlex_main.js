...
<script>
	initFeatures({
        lang : 'ru', // список языков - vn, it, es, hr, en, de, fr, ph, cz, id, th, gr, bg, al, ro, sg, mk, si,sk,lv,hu,pl,lt
...
function initFeatures(settings) {
    ...
    var featuresFilesSrc = (window.location.protocol == 'file:') ? {
        userAva: './img/autoCommentsAva.jpg',
        refreshingArrow: './img/autoCommentsRefreshing.gif',
        autoCommStyles: '',
        popupsStyles: '',
        popupsIconUser: './img/count-user_black.png',
        popupsIconOrder: './img/count-order-984_black.png',
        prizeWheel: './img/prizewheel.png',
        wheelCursor: './img/wheel-cursor.png',
        wheelStyles: '',
        formStyles: ''
    } : {
        userAva: './img/autoCommentsAva.jpg',
    ...
    function genLocalForm() {
        var localForms = {
            'en': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Discount!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Make an order before the discount is given to another reader. <br>Offer expires in:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Write your name:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="John Smith "><label for="phone" class="data_label">Write your phone number:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Phone number"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Заказать ' + settings.product + ' со скидкой 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">The last day of discount giveaway: <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'pt': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">É rentável!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Corra para pedir um desconto até que a oferta seja transferida para o próximo leitor! <br> A oferta ficará inválida em:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Seu nome:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Miguel Castro "><label for="phone" class="data_label">Telefone:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+351....."> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Encomendar ' + settings.product + ' com 70% de desconto!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Oferta válida até (inclusive): <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'ph': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Diskwento!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Umorder na  bago maibigay ang diskwento sa ibang mambabasa.  <br>Ang alok ay matatapos sa loob ng:   <span class="time_remains" id="min">10</span> : <span class="time_remains" id="sec">00</span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Isulat ang pangalan:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Pangalan"><label for="phone" class="data_label">Isulat ang numero ng telepono</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Telepono"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Order ' + settings.product + ' na may 70% na diskwento!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Ang huling araw ng pagbibigay ng diskwento:  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'mk': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Поволно!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Искористете ја можноста за попуст, дури тоа не му е понудено на наредниот читател! <br> Понудата ќе престане да важи по: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Вашето име:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Јован Ѓорѓиев "><label for="phone" class="data_label">Номер телефона:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+389 70 123 456"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Нарачај ' + settings.product + ' со попуст 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Понудата важи до вклучително): <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'si': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Ugodno je!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Utegnite naročiti po nižji ceni, dokler ni ponudba šla za naslednjega bralca! <br>Ponudba je veljavna do:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Vaše ime:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Jure Slavič"><label for="phone" class="data_label">Telefonska številka:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+7 ......."> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Naročiti ' + settings.product + ' s popustom 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Ponudba velja do (vključujoč):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'ru': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Выгодно!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Успейте заказать со скидкой, пока предложение не будет передано следующему читателю! <br>Предложение станет недействительным через:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Ваше имя:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Юрий Петров "><label for="phone" class="data_label">Номер телефона:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+7 977 777 77 77"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Заказать ' + settings.product + ' со скидкой 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Предложение действует до (включительно):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'lt': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Pelninga!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Paskubėkite užsakyti su nuolaida, kol pasiūlymas bus perkeltas į kitą skaitytoją! <br>Pasiūlymas pasibaigs po to, kai:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Jūsų vardas:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Gokhan Karakoc"><label for="phone" class="data_label">Telefono numeris:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+370 123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">UŽSAKYTI ' + settings.product + ' su 70% nuolaida!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Pasiūlymas galioja iki (imtinai):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'pl': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Opłacalne!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Pospiesz się, aby zamówić z rabatem, aż oferta zostanie przekazana do następnego czytelnika! <br>Oferta straci ważność po:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Twoje imię i nazwisko:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Tom Czerniak "><label for="phone" class="data_label">Numer telefonu:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+48 123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">ZAMÓWIĆ ' + settings.product + ' z 70% zniżką!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Oferta ważna do (włącznie):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'hu': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Nyereséges!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Sietj megrendelésre kedvezménnyel, amíg az ajánlat át nem kerül a következő olvasónak! <br>Az ajánlat érvénytelen lesz, miután:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Az Ön neve:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Tóth Vera "><label for="phone" class="data_label">Telefonszám:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+36 12345678"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">RENDELÉS ' + settings.product + ' kedvezményes áron 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Ajánlat (egészen):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
            'lv': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Izdevīgi!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Pasteidzieties, lai pasūtītu ar atlaidi, līdz piedāvājums tiek nodots nākamajam lasītājam! <br>Piedāvājums kļūs nederīgs pēc:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Jūsu vārds:</label><input class="wheel_input" type="text" name="name" id="name" placeholder=" Aivars Janis "><label for="phone" class="data_label">Tālruņa numurs:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+371 0123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">PASŪTĪT ' + settings.product + ' ar atlaidi 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Piedāvājums ir spēkā līdz (ieskaitot):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',
            'sk': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Ziskový!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Ponáhľajte sa na objednávku so zľavou, kým sa ponuka neprevedie na ďalšiu čitateľku! <br> Ponuka bude neplatná po: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Vaše meno:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Vladimir Gordik "><label for="phone" class="data_label">Telefónne číslo:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+421 123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Objednať ' + settings.product + ' s 70% zľavou!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Ponuka je platná do (vrátane):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'sg': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">贏利！</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">快點訂購，直到優惠轉移到下一位讀者! <br>優惠將在以下情況後失效： <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">你的名字：</label><input class="wheel_input" type="text" name="name" id="name" placeholder="王心><label for="phone" class="data_label">电话号码:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="电话号码"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">訂購' + settings.product + '享受50％的折扣！</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">優惠有效期至： <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'bg': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Изгодно!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Успейте да поръчате с отстъпка, докато офертата не се предаде на следващия читател! <br>Офертата ще стане невалидна след:   <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Вашето име:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Име"><label for="phone" class="data_label">Телефонен номер:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Телефон"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Поръчайте ' + settings.product + ' с 70% отстъпка!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Офертата е валидна до (включително):  <span class="time_remains"> ' + outputDat(0, false) + '</span></h2> <br> </center>',

            'hr': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Ovo je korisno!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Požurite na narudžbu uz popust dok se ponuda ne prenese na sljedeći čitatelj! <br>Ponuda će postati nevažeća:   <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Vaše ime:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Ime "><label for="phone" class="data_label">Telefonski broj:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Telefon"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Naručiti ' + settings.product + ' popustom 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Ponuda vrijedi do (uključivo):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'al': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Çmim i ulët!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Arrini ta porositni me zbritje përpara se oferta ti kalojë një lexuesi tjetër! <br>Oferta do të jetë e pavlefshme pas: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Emri i plote:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Florjan Fejzollari"><label for="phone" class="data_label">Numri i celularit:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="ex: +355 1234567890"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Porositeni ' + settings.product + ' me një zbritje prej 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title"> Oferta është e vlefshme deri në (përfshirë):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'id': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Menguntungkan!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Punya wakti untuk memesan dengan harga diskon,<br>sampai penawaran akan ditransfer ke pembaca lain!<br>Diskon akan tidak aktif setelah:<br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Masukkan nama:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Nama"><label for="phone" class="data_label">Masukkan nomor telepon:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Misalnya +62 12345678"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Beli dengan diskon 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Penawaran ini berlaku hingga (inklusif): <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'vn': '',
            'it': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"> <span class="discountс">Conveniente!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Affrettatevi a fare l\'ordine prima che lo sconto passi al prossimo lettore, la vostra offerta unica termina tra: <br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Nome e cognome:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Francesco Rossi"><label for="phone" class="data_label">Telefono cellulare:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Per esempio, +39 0123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Ordinare ' + settings.product + ' con lo sconto 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Ricordate, l\'offerta speciale è valida fino al: <span class="time_remains">' + outputDat(0, false) + '</span> (compreso)</h2> <br> </center>',

            'es': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">DESCUENTO</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Reserve con el precio de promoción antes de que la oferta se pase al siguiente lector! <br>Su tarifa promocional finalizará después de:<br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Nome/Cognome</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Alejandro Rodriguez"><label for="phone" class="data_label">Mob.telefono</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+34 123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Ordene ' + settings.product + ' con 70% de descuento!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">EL NÚMERO DE PRODUCTOS DE OFERTA ES LIMITADO. LOS DESCUENTOS TODAVÍA ESTÁN DISPONIBLES <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'ro': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Reducere!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Cantitatea produsului este limitata, grăbiți-vă să comandați până nu e prea târziu!<br>Reducerea dvs. expiră peste: <br> <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Introduceți numele dvs </label><input class="wheel_input" type="text" name="name" id="name" placeholder="Mihai Orbulescu"><label for="phone" class="data_label">Introduceți numarul dvs de telefon </label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+40 123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">COMANDĂ ' + settings.product + '</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Fiți atenți, oferta este limitată și e valabilă până <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'cz': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Speciální nabídka</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Stíhnete si objednat se slevou, zatím nabídka nepřešla k jinému čtenářovi! <br>Nabídka vyprší za: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Uveďte jméno a příjmení</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Pavel Smejkal"><label for="phone" class="data_label">Uveďte tel.číslo</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+420 123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">OBJEDNAT ' + settings.product + ' SE SLEVOU 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Pozor, akce se speciální slevou trvá pouze do  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'th': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">ราคาถูก!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">จนกว่าสินค้าจะสิ้นสุดโปรโมชั่น <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">ชื่อเต็ม </label><input class="wheel_input" type="text" name="name" id="name" placeholder="ทวีเดช หยาดทอง"><label for="phone" class="data_label">ใส่หมายเลขโทรศัพท์</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+66 123456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">สั่งซื้อ ' + settings.product + ' พร้อมส่วนลด 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">มองหาโปรโมชั่นด้วยราคาพิเศษ ไม่เกิน - 70%  <span class="time_remains">' + outputDat(0, false) + '</span> (รวมทั้ง)</h2> <br> </center>',

            'gr': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Κερδοφόρα!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Έχετε χρόνο για παραγγελία με έκπτωση, έως ότου η προσφορά μεταφερθεί σε άλλους αναγνώστες! <br>Οι εκπτώσεις θα είναι ανενεργές μετά από: <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Εισαγάγετε ένα όνομα</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Πλήρες όνομα"><label for="phone" class="data_label">Εισαγάγετε το τηλέφωνο</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Τηλέφωνο"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Αγορά με έκπτωση 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Αυτή η προσφορά ισχύει μέχρι (συμπεριλαμβάνεται):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'de': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Rabatt!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Beeilen Sie sich, um die Bestellung mit einem Rabatt abzuschließen, bis das Angebot nicht an einen anderen Leser übergeht! <br>Das Angebot wird ungültig nach:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Name:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Tomas Mann "><label for="phone" class="data_label">Telefonnummer:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+49 151 23456789"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">BESTELLEN ' + settings.product + ' MIT RABATT 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Das Angebot gilt bis (einschließlich):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'bg': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Това е изгодно!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Имате време да поръчате това лекарство с отстъпка, докато тази оферта не бъде предадена на други читатели! След това отстъпките ще бъдат деактивирани:<br>  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Въведи име</label><input class="wheel_input" type="text" name="name" id="name" placeholder="ИМЕ "><label for="phone" class="data_label">Въведи телефонен номер</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="Телефон"> <input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Вземи с отстъпка от 70%!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title">Тази оферта е валидна до (включително):<span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>',

            'fr': '<div class="order_block"> <div class="prod_img_wrapper"> <img src="' + settings.form.img + '" width="300" class="prod_img">' + ((settings.form.price) ? '<div class="priceс"><span class="discountс">Réduction!</span> <s><span class="js_old_price price_old"><b class="price_land_s4">{$land_default_prices.s4}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></span></s><br> <b class="new_price js_new_price price_main"><b class="price_land_s1">{$land_default_prices.s1}</b> <b class="price_land_curr">{$land_default_prices.curr}</b></b> </div>' : '') + '</div> <center> <h3 style="text-align: center">Dépêchez-vous de faire une commande un rabais, jusqu\'à ce que l\'offre soit transmise à un autre lecteur! <br>L\'offre sera            invalide dans:  <span class="time_remains" id="min"></span> : <span class="time_remains" id="sec"></span> </h3> </center> <form class="order_form" action="{$url_for_lead_form}" method="POST"> <select class="country_select wheel_input" name="country"></select> <label for="name" class="data_label">Nom:</label><input class="wheel_input" type="text" name="name" id="name" placeholder="Élise Mercier"><label for="phone" class="data_label">Numéro de téléphone:</label> <input class="wheel_input" type="text" id="phone" name="phone" placeholder="+33 6 12 345678"><input type="hidden" name="landing" value="' + window.location.host + '"> <button class="main-link" type="submit">Commandez ' + settings.product + ' avec 70% de réduction!</button> <input type="hidden" name="s1" class="price_field_s1" value="{$land_default_prices.s1}" /><input type="hidden" name="s2" class="price_field_s2" value="{$land_default_prices.s2}" /><input type="hidden" name="s3" class="price_field_s3" value="{$land_default_prices.s3}" />{$form_hidden_fields}</form> </div><center> <h2 class="time_remains_title"> L\'offre est valable jusqu\'au (y compris):  <span class="time_remains">' + outputDat(0, false) + '</span></h2> <br> </center>'
        }
    ...
    function genLocalName() {
        var localNames = {
            ...
            'hu': ["Ágoston", "Ákos", "Alajos", "Andor", "András", "Antal", "Béla", "Benedek", "Bálint", "Barnabás", "Balázs", "Valér", "Vazul", "Gábor", "Géza", "Dávid", "Dezső", "Dömötör", "Dénes", "Zsolt", 'Sára', 'Mariska', 'Diána', 'Amanda', 'Anikó', 'Borbála', 'Erzsébet', 'Éva', 'Gyöngyi', 'Hajnalka', 'Ildikó', 'Jolán', 'Katalin', 'Magdolna', 'Margit', 'Marietta', 'Orsolya', 'Piroska', 'Rózsa', 'Szilvia'],

            'lv': ["Andis", "Didzis", "Sandis", "Aldis", "Edmunds", "Dainis", "Egils", "Aivars", "Valdis", "Pēteris", "Toms", "Normunds", "Mārtiņš", "Māris", "Matiss", "Vilis", "Vitālijs", "Jānis", "Gatis", "Ojārs", 'Zane', 'Vija', 'Jana', 'Anete', 'Evita', 'Solvita', 'Laila', 'Ilze', 'Daina', 'Sintija', 'Estere', 'Terēze', 'Baiba', 'Sanita', 'Kristīne', 'Olga', 'Signe', 'Laura', 'Sandra', 'Agate'],

            'sk': ["Tomáš", "Juraj", "Matuš", "Adam", "Aleš", "Dominik", "Dušan", "Gabriel", "Vladimír", "Imrich", "Pavol", "Ondrej", "Slavomír", "Ján", "Hugo", "Filip", "Viktor", "Maroš", "Stanislav", "Daniel", 'Martina', 'Adera', 'Júlia', 'Anna', 'Tatiana', 'Andrea', 'Kristína', 'Daniela', 'Darina', 'Saška', 'Alexandra', 'Natalia', 'Denisa', 'Ela', 'Elena', 'Lenka', 'Klaudia', 'Katka', 'Katarína', 'Kamila'],
    ...
    if (!!settings.popups && settings.popups.isNeeded) {
        ...
        //функция определения размера скидки (если есть колесо - то будут выводиться разне значения, если нет - то 70%)
    ...
    if (!!settings.wheel && settings.wheel.isNeeded) {
        ...
        var wheelBlocks = {
            'id': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Mencoba keberuntungan Anda!</b><br>Situs kami memberi Anda peluang untuk mendapatkan diskon -70% pada ' + settings.product + '. Untuk melakukan ini, tekan tombol "SPIN" dan tunggu sampai roda keberuntungan berhenti. Mungkin Anda akan beruntung hari ini! Semoga berhasil!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Selamat!</span> <p class="pop-up-text">Anda memenangkan diskon 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'vn': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Xin chú ý!</b><br>Cổng thông tin của chúng tôi cung cấp cho các bạn đọc của mình khuyến mãi giảm giá ưu đãi của sản phẩm ' + settings.product + '. Hãy thử vận may của bạn và nhấp vào nút "SPIN". Nếu may mắn, bạn có thể đặt mua thuốc với mức giá thấp hơn bình thường! Chúc may mắn!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Chúc mừng!</span> <p class="pop-up-text">Bạn đã nhận được giảm giá -70% cho sản phẩm ' + settings.product + '</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'it': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Congratulazioni!</span> <p class="pop-up-text">Potete ordinare ' + settings.product + ' con lo sconto del 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'es': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Felicitaciones!</span> <p class="pop-up-text">¡Has obtenido un descuento del 70% en ' + settings.product + '!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'ro': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Vă felicităm!</span> <p class="pop-up-text">Aţi primit o reducere de -70% pentru ' + settings.product + '!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'cz': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Gratulujeme!</span> <p class="pop-up-text">Teď si můžete objednat ' + settings.product + ' se slevou 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'th': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">ยินดีด้วย!</span> <p class="pop-up-text">คุณสามารถสั่ง ' + settings.product + ' พร้อมส่วนลด 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'gr': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Δοκιμάστε την τύχη σας!</b><br>Ο ιστότοπός μας σας δίνει την ευκαιρία να πάρετε μια έκπτωση 70% στο ' + settings.product + '. Για να το κάνετε, πιέστε το πλήκτρο "SPIN" και περιμένετε να σταματήσει ο τυχερός τροχός. Ίσως να είστε τυχεροί σήμερα! Καλή τύχη!  </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Συγχαρητήρια!</span> <p class="pop-up-text">Κερδίστε έκπτωση 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'de': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Herzlichen Glückwunsch!</span> <p class="pop-up-text">Sie können ' + settings.product + ' mit einem Rabatt von 70% bestellen!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'bg': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Опитай късмета си!</b><br>Нашият сайт ви дава възможност да получите 70% отстъпка от цената на лекарството Erogan. За да направите, това натиснете бутона "SPIN" и изчакайте, докато спре колелото на късмета. Може би, днес ще имаш късмет точно ти! Успех!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Честито!</span> <p class="pop-up-text">Ти печелиш 70% отстъпка!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'fr': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Félicitations!</span> <p class="pop-up-text">Vous pouvez commander ' + settings.product + ' avec la réduction 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'al': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Kujdes!</b><br>Portali ynë i ofron lexuesve mundësinë të përfitojë një zbritje deri në -70% për ' + settings.product + '. Shtypni butonin “SPIN”, dhe prisni deri sa te ndalojë rrota e fatit! Ndoshta pikërisht juve do t’iu buzëqesh sot fati, dhe do të keni mundësinë të bëni porosinë me vetëm gjysëm çmimi! Ju urojmë fat!</p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Ju përgëzojmë!</span> <p class="pop-up-text">Ju mund ta porositni ' + settings.product + ' me një zbritje prej 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'ru': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Внимание!</b><br>У поситителей нашего сайта есть эксклюзивная возможность заказать ' + settings.product + ' со скидкой до 70%! Для этого запустите колесо фортуны нажатием на кнопку "SPIN", и затем дождитесь его полной остановки. Кто знает, может именно Вы тот счастливчик, которому сегодня удастся неплохо сэкономить! Удачи! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Поздравляем!</span> <p class="pop-up-text">Вы можете заказать ' + settings.product + ' со скидкой 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },


            'lt': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Dėmesio!</b><br>Mūsų svetainės lankytojai turi išskirtinę galimybę užsisakyti. ' + settings.product + ' iki 70% nuolaida! Norėdami tai padaryti, paleiskite likimo ratą paspaudę mygtuką „SPIN“ ir palaukite, kol jis visiškai sustos. Kas žino, gal jūs esate laimingas, kuris šiandien galės sutaupyti pinigų! Sėkmės! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Sveikiname!</span> <p class="pop-up-text">Galite užsisakyti ' + settings.product + ' su 70% nuolaida!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'pl': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Uwaga!</b><br>Odwiedzający naszą stronę mają wyłączną możliwość zamówienia. ' + settings.product + ' do 70% taniej! Aby to zrobić, uruchom koło fortuny, naciskając przycisk "SPIN", a następnie zaczekaj, aż całkowicie się zatrzyma. Kto wie, może jesteś szczęściarzem, który może dziś zaoszczędzić dużo pieniędzy! Powodzenia! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Gratulacje!</span> <p class="pop-up-text">Możesz zamówić ' + settings.product + ' z 70% zniżką!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },


            'hu': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Figyelem!</b><br>Honlapunk látogatói kizárólagos lehetőséget biztosítanak a megrendelésre. ' + settings.product + ' akár 70% kedvezmény! Ehhez indítsa el a szerencse kerékét a "SPIN" gomb megnyomásával, majd várja meg, amíg teljesen leáll. Ki tudja, talán te vagy a szerencsés ember, aki ma sok pénzt takaríthat meg! Sok szerencsét! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Gratulálunk!</span> <p class="pop-up-text">Rendelhet ' + settings.product + ' 70% kedvezmény!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'lv': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Uzmanību!</b><br>Mūsu vietnes apmeklētājiem ir ekskluzīva iespēja pasūtīt. ' + settings.product + ' līdz 70% atlaide! Lai to izdarītu, ieslēdziet laimes riteni, nospiežot pogu "SPIN", un pēc tam pagaidiet, līdz tas pilnībā apstājas. Kas zina, varbūt esat laimīgs, kurš šodien var ietaupīt daudz naudas! Good luck! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Apsveicam!</span> <p class="pop-up-text">Jūs varat pasūtīt ' + settings.product + ' ar 70% atlaidi!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'sk': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Varovanie!</b><br>Naši návštevníci stránok majú exkluzívnu príležitosť objednať ' + settings.product + ' až 70% z ceny! Ak to chcete urobiť, spustite kolo šťastia stlačením tlačidla "SPIN" a počkajte, kým sa úplne zastaví. Kto vie, možno ste šťastný, kto dnes ušetrí peniaze! Veľa šťastia! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Blahoželáme!</span> <p class="pop-up-text">Môžete si ho objednať ' + settings.product + ' s 70% zľavou!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'si': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Pozor!</b><br>Obiskovalci naše spletne strani imajo enkratno možnost naročila ' + settings.product + ' s popustom do 70%! Za to zavrtite kolo fortune s pritiskom gumba "SPIN" in počakajte da se zaustavi. Kdo ve, mogoče ste Vi ta srečnež, ki bo lahko danes privarčeval z denarjem! Srečno! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Čestitamo!</span> <p class="pop-up-text">Lahko naročite ' + settings.product + ' s popustom 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'mk': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Внимание!</b><br> Посетителите на нашата веб-страна имаат ексклузивна можност да нарачаат ' + settings.product + ' со попуст до 70%! Потребно е да си ја пробате среќата со притискање на копчето "SPIN", и потоа да почекате до неговото целосно запирање. Кој знае, можеби токму Вие сте тој среќник, кој што денеска добро ќе заштеди! Среќно! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Ви честитаме!</span> <p class="pop-up-text"> Вие можете да нарачате ' + settings.product + ' со попуст 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',
            ...
            'sg': {
                ...
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">稱慶!</span> <p class="pop-up-text">你可以訂購' + settings.product + '享受50％的折扣！</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'bg': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Внимание!</b><br>Посетителите на нашия сайт имат изключителната възможност да поръчат ' + settings.product + ' с 70% отстъпка! За тази цел трябва да завъртите колелото на късмета като натиснете бутона "SPIN" и след това да изчакате докато то спре напълно. Кой знае, може би точно Вие сте този късметлия, който днес ще успее хубаво да спести! Късмет! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Честито!</span> <p class="pop-up-text">Можете да поръчате ' + settings.product + ' с 70% отстъпка! </p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'hr': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Pozor!</b><br>Posjetitelji naše stranice imaju ekskluzivnu mogućnost naručivanja ' + settings.product + ' s popustima do 70%! Za ovo morate pokreniti kotač sreće pritiskom na gumb "SPIN", i onda pričekajte da se potpuno zaustavi. Tko zna, možda Vi ste sretni koji će danas uspjeti uštedjeti svoj novac! Sretno! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Čestitamo!</span> <p class="pop-up-text">Možete naručiti ' + settings.product + ' popustom 70%!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'ph': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Atensyon!</b><br> Ang aming mambabasa ay may eksklusibong pagkakataong umorder ' + settings.product + '  na may diskwento hanggang 70%! Pindutin ang “SPIN” button para maumpisahan ang fortune wheel at antaying tumigil. Malay mo, baka ikaw ang maswerteng tao na makakuha ng pinakamagandang diskwento ngayon! Good luck! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Binabati kita!</span> <p class="pop-up-text">Pwedeng umorder ' + settings.product + ' na may 70% na diskwento !</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'en': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Attention!</b><br>Our readers have an exclusive opportunity to order ' + settings.product + ' with discount up to 70%! Just launch the fortune wheel by pressing the "SPIN" button, and wait for it to stop. Who knows, maybe it is you that lucky guy, who will get the best discount today! Good Luck! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Congratulations!</span> <p class="pop-up-text">You can order ' + settings.product + ' with a 70% discount!</p> <span class="pop-up-button">Ok</span> </div> </div>',

            },
            'pt': {
                wheel: '<span class="toform"></span><div class="spin-wrapper"><p><b>Atenção!</b><br>Os visitantes do nosso site têm a oportunidade exclusiva de encomendar ' + settings.product + ' com um desconto de até 70%! Para fazer isso, inicie a roda da fortuna clicando no botão "SPIN" e espere que ele pare completamente. Quem sabe, talvez você seja o sortudo que consiga economizar muito dinheiro hoje! Boa sorte! </p> <div class="wheel-wrapper"> <div class="wheel"> <img alt="" class="wheel-img" src="' + (settings.wheel.customWheel || featuresFilesSrc.prizeWheel) + '"> <div class="wheel-cursor"> <img alt="" src="' + featuresFilesSrc.wheelCursor + '"><span class="cursor-text">SPIN</span></div> </div> </div> </div>',
                popup: '<div class="spin-result-wrapper"> <div class="pop-up-window"> <div class="close-popup"></div> <span class="pop-up-heading">Parabéns!</Span> <p class="pop-up-text">Você pode encomendar ' + settings.product + ' com 70% de desconto!</p> <span class="pop-up-button">Ok</span> </div> </div>',
